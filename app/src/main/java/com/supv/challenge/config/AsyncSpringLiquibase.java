package com.supv.challenge.config;

import static com.supv.challenge.util.ConfigConstants.*;
...
/**
 * Specific liquibase.integration.spring.SpringLiquibase that will update the
 * database asynchronously and close DataSource if necessary.
 * <p>
 * By default, this asynchronous version only works when using the "dev"
 * profile.
 * <p>
 * The standard liquibase.integration.spring.SpringLiquibase starts Liquibase in
 * the current thread:
 * <ul>
 ...
 * </ul>
 * But as this is a rather slow process, we use this asynchronous version to
 * speed up our start-up time:
 * <ul>
 * <li>On a recent MacBook Pro, start-up time is down from 14 seconds to 8
 * seconds</li>
 * <li>In production, this can help your application run on platforms like
 * Heroku, where it must start/restart very quickly</li>
 * </ul>
 */
