...
public class HeaderUtil {
	 ...
	 * @param entityName        a {@link java.lang.String} object.
	 * @param param             a {@link java.lang.String} object.
	 * @param param2            a {@link java.lang.String} object.
	 * @return a {@link org.springframework.http.HttpHeaders} object.
	 */
	public static HttpHeaders createEntityMatchedAlert(String applicationName, boolean enableTranslation,
			String entityName, String param, String param2) {
		String message = enableTranslation ? applicationName + "." + entityName + ".matched"
				: "A " + entityName + " is matched with identifier " + param + " with the  " + entityName
						+ " with identifier " + param2;
		return createAlert(applicationName, message, param);
	}
}
