 ...
 * {@code spring.profiles.active} set in the environment or as command line
 * argument. If the value is not available in {@code application.yml} then
 * {@code dev} profile will be used as default.
 */
public class DefaultProfileUtil {
	...
	public static void addDefaultProfile(SpringApplication app) {
		 ...
		 * set in the application.yml file. See
